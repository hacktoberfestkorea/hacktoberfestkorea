...
- DigitalOcean에서 주관하는 오픈소스 소프트웨어 행사로서 올해로 11회째인 행사입니다.
- 10월 한달동안 오픈소스 저장소에 기여를 하면 디지털 배지를 받을 수 있습니다.
...
- 올해에도 로우코드(low-code), 노코드(no-code) 참여를 공식적으로 허용하고 강조하고 있습니다.
...
- _저장소를 운영하시는 분들 중에 참여하고자 하시는 분들은 [여기](https://github.com/phg98/hacktoberfestkorea/edit/master/docs/index.md)를 클릭하세요. 저장소에 ''hacktoberfest'라는 topic을 꼭 넣어주시구요. 올해에는 참여하지 않으신다면 링크 삭제 부탁드립니다. 응원합니다!_
...
- [phg98](https://github.com/phg98)
- [KangManJoo](https://github.com/eogns47)
...
- 작년 내용을 보시려면 [2023 Hacktoberfest Korea Unofficial](https://2023.hacktoberfestkorea.com)을 참고하세요
...
- 2023년도 행사 Github 저장소 : [Hacktoberfest Korea 2023](https://github.com/hacktoberfestkorea/hacktoberfestkorea/tree/2023)
